...
Pour cela, nous pouvons utiliser la fonction **[`minimal_html()`](https://rvest.tidyverse.org/reference/minimal_html.html)** qui permet de créer un contenu HTML (XML) requêtable à partir de code HTML fourni dans une chaîne de caractères.
...
- Les fonctions **[`html_element()`](https://rvest.tidyverse.org/reference/html_element.html)** ou `html_elements()` permettent respectivement la récupération du 1er ou de tous les éléments d'un document HTML, en précisant un sélecteur CSS ou un Xpath.
...
- La fonction **[`html_attr()`](https://rvest.tidyverse.org/reference/html_attr.html)** permet l'extraction des valeurs d'attributs. 
...
- Les fonctions **[`html_text()`](https://rvest.tidyverse.org/reference/html_text.html)** ou `html_text2()` permettent d'extraire uniquement le texte d'un élément.
...
Nous commençons par récupérer le code source de ces deux pages avec la fonction **[`read_html()`](https://rvest.tidyverse.org/reference/read_html.html)**.
