...
### Collecte des URLs de chaque annonce
...
``` {r echo= TRUE, message=FALSE, warning=FALSE}
code_appart %>% html_elements(".stretched-link") %>%  html_attr("href")
```

Nous pouvons faire la même chose pour les annonces de vente de maison en Seine-Maritime :

``` {r echo= TRUE, message=FALSE, warning=FALSE}
code_maison %>% html_elements(".stretched-link") %>%  html_attr("href")
```
