...
0) Ouverture le bon coin thématique : même logique dans ce faux site et dans le site réel, collection d'annonces individuelles : on peut récupérer des résumés de plusieurs annonces (pages résultats) ou les détails de chaque annonce (page annonce)
1) Questions éthiques + exemple le bon coin éthique
2) Questions bonnes pratiques
  -> commencer par chercher les données avant de les scraper
  -> puis les demander
  -> si pas moyen, scraping
3) Ouverture vers sites dynamiques, renvoi au site
4) ne pas hésiter à demander à ChatGPT ou à Hugues de l'aide
