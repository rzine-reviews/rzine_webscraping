...
[^3]: « **HTML5** (*HyperText Markup Language 5*) est la dernière révision majeure du HTML (format de données conçu pour représenter les pages *web*).
...
<center>[<img src="figures/zip.png" width="30"/> **exo_HTML.zip**](https://github.com/rzine-reviews/rzine_webscraping/raw/refs/heads/master/exo_HTML.zip)</center>
...
<center>[<img src="figures/zip.png" width="30"/> **correction_exo_HTML.zip**](https://github.com/rzine-reviews/rzine_webscraping/raw/refs/heads/master/correction_exo_HTML.zip)</center>
...
[^4]: L'appellation R-base utilisée tout au long de ce document désigne l'ensemble des fonctions natives de R, c'est-à-dire installées d'office avec le logiciel, sans ajout de *packages* supplémentaires.
...
[^5]: Nous privilégions ici un nettoyage écrit en R, et faisant appel notamment à des fonctions parfois avancées de manipulation de chaînes de caractères, mais il existe aussi des outils graphiques plus conviviaux permettant de mener cette phase importante, comme [OpenRefine](https://openrefine.org/) par exemple.
