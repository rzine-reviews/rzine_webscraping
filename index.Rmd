...
En sciences humaines et sociales, le *web scraping* peut être utilisé pour collecter efficacement des données pertinentes sur des sites *web*, forums, blogs, des réseaux sociaux, ou autres sources en ligne. Par exemple, si des centaines de tableaux de données sont disponibles sur un site web et dont l'analyse permettrait d'étayer différentes hypothèses de recherches, il parait préférable d'en automatiser la collecte plutôt que de les copier/coller manuellement.
