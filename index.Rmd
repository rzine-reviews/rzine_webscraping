...
Pour cette introduction, notre objectif est de récupérer l'intégralité de la base de données des biens mis en vente sur [**ScrapImmob**](https://analytics.huma-num.fr/Robin.Cura/ScrapImmob/index.html), incluant l'ensemble des caractèristiques décrivant les biens. La récupération des coordonnées géographiques affichées dans la carte intéractive est également souhaitée.



Pour répondre a cet objectif, le processus de collecte va se dérouler en plusieurs étapes :

1. Comprendre le système d'URL du site afin de pouvoir récupérer tous les biens mis en avant sur le site.

2. A partir de la liste des URL de toutes les pages à scraper, collecter l'ensemble des caractèristiques de chaque bien.
